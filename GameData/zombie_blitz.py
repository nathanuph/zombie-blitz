...
def get_pre_game_assets(): #dynamically gets the assets for the pregame
    assets = [
        ...
        Images("Sprites/player headshot.png", (40,50), (175,175)), #headshot of the main character
...
credits.assets = [
    ...
    SceneText(" - some sprites drawn by Nathan Uphill", Vector(0,150), 30, (255,255,255)), 
    SceneText(" - @nathanuph on github", Vector(0,250), 30, (255,255,255)), 
    SceneText(" - Backgrounds / some sprites generated by Google Gemini", Vector(0,350), 26, (255,255,255)), 
