...
pre_game.assets = [
    ...
    Images(player.sprite, (50,75), (175,175)), #the main characters sprite
    ...
    Button((0,0,0), Vector(260,130), Vector(100,50), "STORE", None), #shop button
    Button((0,0,0), Vector(260,190), Vector(150,50), "INVENTORY", None), #shop button

    SceneText("Equipped:", Vector(70,260), 25, (0,0,0)), #'equipped' 
    Images(player.weapon.sprite, (70,270), (100,100)), #image of gun currently equipped
